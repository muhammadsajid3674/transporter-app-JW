...
import BookinSlots from './bookingSlots';
    ...
    const [menuLinks, setMenuLinks] = React.useState([
        {
            ...
            routeName: "bookingSlots",
            iconClass: "fa-solid fa-info"
        },
        {
            displayName: "Available Transport",
            routeName: "availableTransports",
            iconClass: "fa-solid fa-info"
        },
    ]);
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <Main open={open} sx={{ backgroundColor: '#ced4da' }}>
                <DrawerHeader />
                <Routes> 
                    <Route path='bookingSlots' element={<BookinSlots/>}/>
                    <Route path='availableTransports' element={<AvailableTransport/>}/>
                </Routes>
            </Main>
        </Box>
    );
